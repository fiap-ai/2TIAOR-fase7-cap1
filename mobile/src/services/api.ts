/**
 * API service layer for CardioIA mobile app.
 * Same endpoints as the web app, adapted for React Native.
 */

const API_BASE =
  process.env.EXPO_PUBLIC_API_URL || "https://twotiaor-fase7-cap1.onrender.com";
